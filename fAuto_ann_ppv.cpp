...
/**
    Fonction qui applique le calcul de distance entre vecteur de descritpion SIFT a un esnemble de fichier de point d'interet prend en entrée le fichier de reference
**/
